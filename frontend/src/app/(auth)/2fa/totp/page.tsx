...
import { use2FATOTP } from "@/hooks/auth/use2FA";
import { totpSchema, type TotpInput } from "@/schema/auth.schema";
...
export default function TwoFactorTOTPPage() {
  ...
  const onSubmit = (data: TotpInput) => {
    if (!pendingSessionId) return;
    verify({ pendingSessionId, code: data.code });
  };
